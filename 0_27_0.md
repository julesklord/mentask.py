...
**Acción para MentAsk:** Implementar `SubagentTool`. Permitirá que MentAsk asigne tareas complejas (como "haz un review de seguridad") a un agente hijo, recibiendo solo el resumen final. Esto evita la explosión de tokens en el hilo principal.
